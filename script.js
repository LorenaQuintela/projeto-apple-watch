...
function trocarImagem (){
    ...
    imagemSelecionada = idOpcaoSelecionada.charAt(0);//pega o primeiro caracter que está na posição 0
    imagemVisualizacao.src = './imagens/opcoes-cores/' + opcoesCores[corSelecionada].pasta + '/imagem-' + imagemSelecionada + '.jpeg';
}

function trocarTamanho (){ 
    //atualizar variável de controlo do tamanho da caixa
...
function trocarCor (){
    ...
    //trocar titulo da página de acordo com a cor selecionada
    tituloProduto.innerText = "Pulseira loop esportiva " + opcoesCores[corSelecionada].nome + " para caixa de " + opcoesTamanho[tamanhoSelecionado];
    //trocar titulo(nome) da cor
